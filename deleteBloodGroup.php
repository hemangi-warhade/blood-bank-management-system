...
<html>
<head>
<title>Delete Blood Group | Online Blood Management </title>
...
if(isset($_POST['deleteBlood'])) 
 { 
		...
		$sql = 'delete blood_Details where blood_id = :bloodId' ;
		$stmt = oci_parse($conn,$sql);
		...
		$msg = ' Blood Group Details deleted successfully for Blood ID :   '.$bloodId;  //returns the second argument passed into the function
  }
...
<div class="container">
    <div class="single">  
	   <div class="form-container">
        <h2>Delete Blood Group Details</h2>
        ...
        <div class="row">
            <div class="form-actions floatRight">
                <input type="submit" name="deleteBlood" value="Delete Blood Group Details" class="btn btn-primary btn-sm">
            </div>
        </div>
    </form>
    </div>
