...
<html>
<head>
<title>Donor Finder | Online Blood Management </title>
...
<div class="container">
	   ...
	   <div class="form-container">
        ...
        <div class="row">
            <div class="form-actions floatRight">
                <input type="submit" name="findDonor" value="Find Donor" class="btn btn-primary btn-sm">
            </div>
        </div>
		<br><br>
	...
	<div class="CSSTableGenerator" >
				...
				<?php
					...
					$sql = 'select * from blood_user_profile where type = \'D\' and upper(location) like upper(:location) and upper(blood_group) like upper(:bloodGroup) order by name ';
