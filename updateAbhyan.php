...
<html>
<head>
<title>Update Abhyan Details | Online Blood Management </title>
...
<?php
if(isset($_POST['updateAbhyanDetails'])) 
{ 
$abhyanId = $_POST['abhyanId'];
...
$sql = 'update abhyan_details set abhyan_name = :abhyanName , abhyan_description = :abhyanDescription , abhyan_location = :abhyanLocation , abhyan_event_date = :abhyanEventDate'.
...
<?php				
$msg="Details updated for Abhyan - ".$abhyanName ;	
}
...
<div class="container">
    <div class="single">  
	   <div class="form-container">
        ...
        <div class="row">
            <div class="form-actions floatRight">
                <input type="submit" name="updateAbhyanDetails" value="Update Abhyan Details" class="btn btn-primary btn-sm">
            </div>
        </div>
    </form>
